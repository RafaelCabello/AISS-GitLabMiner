...
public class Issue {
    ...
    public Issue(String id, String refId, String title, String description, String state, String createdAt, String updatedAt, String closedAt, List<String> labels, UserSearch author, UserSearch assignee, Integer upvotes, Integer downvotes, String webUrl) {
        this.id = id;
        this.refId = refId;
        this.title = title;
        this.description = description;
